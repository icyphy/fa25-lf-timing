; ModuleID = '/home/gametime/test/lf-gametime-TCP2/client_reaction_function_2_analysis/client_reaction_function_2gt/feasible-path3/client_reaction_function_2_klee_format_linked.ll'
source_filename = "/home/gametime/test/lf-gametime-TCP2/client_reaction_function_2_analysis/client_reaction_function_2gt/feasible-path3/client_reaction_function_2_klee_format.c"
...
@conditional_var_4 = dso_local global i8 1, align 1
...
@.str.8 = private unnamed_addr constant [158 x i8] c"/home/gametime/test/lf-gametime-TCP2/client_reaction_function_2_analysis/client_reaction_function_2gt/feasible-path3/client_reaction_function_2_klee_format.c\00", align 1
...
define dso_local [2 x i64] @_clientreaction_function_2(ptr noundef %0, ptr noundef %1, i64 noundef %2, i32 noundef %3, [2 x i64] %4) #0 {
  ...
  %17 = call noalias ptr @malloc(i64 noundef 12) #6
...
; Function Attrs: alwaysinline nounwind uwtable
define internal i32 @randint(i32 noundef %0, i32 noundef %1) #4 {
...
define internal i64 @read_time_hw() #4 {
  ...
  %2 = call i64 asm sideeffect "rdtime $0", "=r"() #7, !srcloc !8
