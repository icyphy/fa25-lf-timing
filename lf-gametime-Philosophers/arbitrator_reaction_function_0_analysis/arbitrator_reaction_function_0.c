...
// Reactor: arbitrator_reaction_function_0
// Generated from LF compiler output

void _arbitratorreaction_function_0(size_t* num_philosophers, bool** forks, int** replies, size_t* finished_philosophers, size_t* arbitration_id, size_t* retries) {
    (*forks) = calloc(*num_philosophers, sizeof(bool));
        (*replies) = calloc(*num_philosophers, sizeof(int));
}
