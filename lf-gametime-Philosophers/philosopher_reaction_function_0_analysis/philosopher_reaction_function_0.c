...
// Reactor: philosopher_reaction_function_0
// Generated from LF compiler output

bool _philosopherreaction_function_0(size_t* bank_index, size_t* count, int* times_eaten, bool start) {
    bool __output_hungry;
    printf("Hello! I am philosopher %zu, and I am very hungry!", *bank_index);
        (*times_eaten) = 0;
