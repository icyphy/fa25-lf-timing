...
// Reactor: reducer_reaction_function_1
// Generated from LF compiler output

void _reducerreaction_function_1(int* jobs_completed, long* total_latency_ms, int from_worker2) {
    map_result_t result = from_worker2;
